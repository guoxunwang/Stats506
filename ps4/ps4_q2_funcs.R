##Stats 506, F18, Problem Set 4, Question 2
##
##functions for problem set 3, question 2
##Monte Carlo simulation to compute p-values
##create a evaluate function to compute four quantities
##copy from solutions of problem set3, question 2
##
